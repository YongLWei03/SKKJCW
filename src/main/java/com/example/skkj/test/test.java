...
public class test {
    ...
    public static void main(String[] args) throws Exception {
        ...
        String sheetName = "设备添加授权";
        String titleName = "设备添加授权（不能为空 大小不能超过1M）";
        String fileName = "---";
        int columnNumber = 4;
        int[] columnWidth = { 20,20,20,20};
        String[][] dataList = { { "XXX", "XXX", "XXX","XXX"}};
        String[] columnName = {  "设备ID","设备负责人","设备负责人手机号","对应开关柜"};
        new test().ExportNoResponse(sheetName, titleName, fileName,
    ...
    public void ExportNoResponse(String sheetName, String titleName,
        ...
        System.out.println("columnWidth.length:"+columnWidth.length);
        ...
        if (columnNumber == columnWidth.length&& columnWidth.length == columnName.length) {
            ...
            // 第六步，将文件存到指定位置
            try {
                FileOutputStream fout = new FileOutputStream("设备添加授权.xls");
                wb.write(fout);
