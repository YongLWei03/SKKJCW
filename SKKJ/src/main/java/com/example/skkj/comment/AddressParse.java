...
public class AddressParse {
     ...
     */
     public static Map geodecode(String xy){
            String sUrl="http://api.map.baidu.com/geocoder/v2/?ak=0bcrcezCrEBGNzv13ohdTCcr4F2w52Tz&location="+xy + "&output=json&pois=0";
             String address="";
    ...
    public static String geocode(String addr){
        ...
        try {
            ...
            String sUrl="http://api.map.baidu.com/geocoder/v2/?address="+addr+"&output=json&ak=0bcrcezCrEBGNzv13ohdTCcr4F2w52Tz";
            java.net.URL url = new java.net.URL(sUrl);
    ...
    public static void main(String [] args){
        String xy = AddressParse.geocode("成都市祥和佳苑");
